...
//將西元年轉為民國年
function yearsub1911(date){ //2020-12-03
    var a = date.split('-');
    return ((parseInt(a[0])-1911)+'-'+a[1]+'-'+a[2]);
}
//將民國年轉為西元年
function yearadd1911(date){ //109-12-03
    var a = date.split('-');
    return ((parseInt(a[0])+1911)+'-'+a[1]+'-'+a[2]);
}
(function(){
    ...
    var twSettings = {
        ...
        yearRange: (dateNative.getFullYear()-10)+':'+(dateNative.getFullYear()+10),
        monthNames: [
            '一月','二月','三月','四月','五月',
            '六月','七月','八月','九月','十月',
            '十一月','十二月'
